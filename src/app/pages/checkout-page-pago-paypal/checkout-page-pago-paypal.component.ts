...
@Component({
  selector: 'app-checkout-page-pago-paypal',
  templateUrl: './checkout-page-pago-paypal.component.html',
  styleUrls: ['./checkout-page-pago-paypal.component.scss']
})
export class CheckoutPagePagoPaypalComponent implements OnInit {
